...
def init_for(env):
	...
	foursquare_client.oauth = foursquare_client.OAuth(app.config['FOURSQUARE_CLIENT_ID'], app.config['FOURSQUARE_CLIENT_SECRET'], None)
	foursquare_client.base_requester = foursquare_client.Requester(app.config['FOURSQUARE_CLIENT_ID'], app.config['FOURSQUARE_CLIENT_SECRET'])
	foursquare_client._attach_endpoints()
