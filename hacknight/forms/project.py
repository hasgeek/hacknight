...
class ProjectForm(Form):
    ...
    description = RichTextField(u"Description", description="Describe your project with supporting links and other pointers.", validators=[wtf.Required('Please describe your project.')])
