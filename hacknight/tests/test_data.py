...
EVENT_DESCRIPTION = u"""The data hacknight is open to enthusiasts, geeks, designers, mathematicians and statisticians. It is an occasion to work on a data project that you have always wanted to,
be it:
...
EVENTS = [{'description': EVENT_DESCRIPTION, 'website': u'http://fifthelephant.in/2012', 'status': EVENT_STATUS.PUBLISHED, 'ticket_price': 500,\
