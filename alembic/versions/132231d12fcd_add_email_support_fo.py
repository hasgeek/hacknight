...
def upgrade():
    op.add_column('event', sa.Column('confirmation_message', sa.UnicodeText))
    op.add_column('event', sa.Column('confirmation_message_text', sa.UnicodeText))
    op.add_column('event', sa.Column('waitlisted_message', sa.UnicodeText))
    op.add_column('event', sa.Column('waitlisted_message_text', sa.UnicodeText))
    op.add_column('event', sa.Column('rejected_message', sa.UnicodeText))
    op.add_column('event', sa.Column('rejected_message_text', sa.UnicodeText))
